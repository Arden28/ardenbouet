      ...
      en: {
        translation: {
          ...
          hero: {
            ...
            description: {
              phrase1: "I'm <strong>Arden BOUET</strong>, a travel tech engineer specializing in the design and development of scalable mobility, navigation, and travel systems. Proven experience building full-stack, multi-tenant platforms leveraging <strong>Laravel (PHP)</strong>, <strong>Java (Spring Boot)</strong>, <strong>React (Web & Mobile)</strong>, and <strong>Next.js</strong>, backed by robust data layers using <strong>PostgreSQL/PostGIS</strong>, <strong>MySQL</strong>, and <strong>Redis</strong>",
              phrase2: 'Strong expertise in geospatial architectures and map-centric systems, including routing engines such as OpenTripPlanner, real-time data pipelines, and interactive navigation platforms. Focused on delivering high-performance systems that handle complex spatial queries, live transit data, and large-scale user interactions.',
              phrase3: "Skilled in architecting clean, modular systems with well-defined APIs, scalable backend services, and production-ready infrastructure. Combines solid system design with a strong UX mindset to build intuitive, map-driven interfaces and end-to-end travel platforms engineered for reliability, scalability, and continuous evolution.",
            },
